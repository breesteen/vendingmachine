...
//WHILE LOOP MAKE BOOLEAN VARIABLE SET TO FALSE LOOP WHILE FALSE SO YOU ARENT ADDING TO THE STACK AND RERUNNING PROGRAM
                ...
                case "2":
                    ...
                    try {
                        if(map.get(selectedCode).getStock() == 0){
                            ...
                            System.out.println("");
                            displayPurchaseMenu(userInput, vendingMachine, inventoryClass, map);
                        }//SEPARATE THIS LOGIC TAKE OUT OF MENU SO IT IS TESTABLE
